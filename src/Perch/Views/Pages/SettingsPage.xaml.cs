...
public partial class SettingsPage : Page
{
    ...
    private void Hotkey_PreviewKeyDown(object sender, KeyEventArgs e)
    {
        ...
        {
            Warn("Use Ctrl, Alt, Shift or Win with the key.");
            return;
        }
    ...
    private void OnHotkeyFailed(string name, string gesture) =>
        Dispatcher.BeginInvoke(() =>
            Warn($"{gesture} is already used by another program."));
    ...
    private void General_Changed(object sender, RoutedEventArgs e)
    {
        ...
        if (startup != general.StartWithWindows)
        {
            ...
            MainWindow.Say(
                ...
                startup ? "Perch starts with Windows." : "Perch no longer starts with Windows.");
        }
