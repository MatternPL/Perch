...
public partial class RulesPage : Page
{
    ...
    private void NewRule_Click(object sender, RoutedEventArgs e)
    {
        ...
        App.Config.Save();
        Refresh();
        MainWindow.Say("Rule created", $"{rule.DisplayName} added.");
    }
    ...
    private void ApplyRule_Click(object sender, RoutedEventArgs e)
    {
        ...
        MainWindow.Say("Applied", $"{row.Rule.ProcessName} moved.");
    }
    ...
    private void ApplyAll_Click(object sender, RoutedEventArgs e)
    {
        ...
        MainWindow.Say(
            ...
            count == 0 ? "No open windows match a rule." : $"Moved {count} window(s).");
    }
...
public sealed class RuleRow
{
    ...
    public string Detail
    {
        get
        {
            ...
            var top = Rule.AlwaysOnTop ? ", on top" : "";

            return $"{Rule.ProcessName}.exe on {where}, {state}{title}{top}";
        }
    }
}
